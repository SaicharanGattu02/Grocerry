...
class Constant {
  ...
  static String hostUrl = "https://admin.payjet.in/";

  static String baseUrl = "${hostUrl}customer/";

  static String packageName = "com.pay.jet";
  ...
  //google api keys
  static String googlemapApiKey = "AIzaSyD0-eauuJ1zBrknaL4uNexkR21cYVOkj7k";
...
//Order statues codes
  ...
  // https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=-33.8670,151.1957&radius=500&types=food&name=cruise&key=API_KEY
   ...
   static String apiGeoCode =
      "https://maps.googleapis.com/maps/api/geocode/json?key=${Constant.googlemapApiKey}&latlng=";
