...
class FasTagRechrge extends StatefulWidget {
  const FasTagRechrge({super.key});

  @override
  State<FasTagRechrge> createState() => _FasTagRechrgeState();
}

class _FasTagRechrgeState extends State<FasTagRechrge> {
  final TextEditingController _mobileNumberController = TextEditingController();
  final TextEditingController _selectOperatorController = TextEditingController();
  final TextEditingController _amountController = TextEditingController();
  final TextEditingController _vechileNumberController = TextEditingController();

  String _validateMobileNumber = "";
  String _validateAmount = "";
  String _validateOperator = "";
  String _validateVechleNumber = "";
  ...
  void _validateFields() {
    setState(() {
      ...
      _validateOperator = _selectOperatorController.text.isEmpty
          ...
          : "";
      _validateVechleNumber = _vechileNumberController.text.isEmpty
  ...
  void initState() {
    ...
    _vechileNumberController.addListener(() {
      setState(() {
        _validateVechleNumber = "";
      });
    });
  }
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [Padding(
          ...
          child: Text("Recents", style: TextStyle(color: Color(0xffD40B2E),
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    _buildTextFormField(
                      controller: _vechileNumberController,
                      validation: _validateVechleNumber,
