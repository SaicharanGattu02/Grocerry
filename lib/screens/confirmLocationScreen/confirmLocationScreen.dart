import 'package:egrocer/helper/generalWidgets/googleMapSearchLocationWidgets/flutterGooglePlaces.dart';
...
class _ConfirmLocationState extends State<ConfirmLocation> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: WillPopScope(
          onWillPop: () async {
            // Delayed action before performing pop
            await Future.delayed(const Duration(milliseconds: 500));
            // Perform the pop action with the result
            Navigator.pop(context, true);

            // Return false to indicate that we have handled the pop and the default behavior should not occur
            return false;
          },
                      ...
                      Expanded(
                        ...
                        onTap: () async {
                          Prediction? p = await PlacesAutocomplete.show(
                              context: context,
                              apiKey: Constant.googlemapApiKey,
