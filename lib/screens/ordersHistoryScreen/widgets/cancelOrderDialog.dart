  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () async {
        ...
        final status = updateOrderStatusProvider.getUpdateOrderStatus();

        if (status == UpdateOrderStatus.inProgress) {
          // Pop the current route and return true to indicate the navigation should proceed
          Navigator.pop(context, true);
          return false; // Prevent the default back navigation
        } else {
          // Allow the default back navigation to proceed
          return true;
        }
      },
      child: AlertDialog(
