...
import 'package:egrocer/screens/productListFilterScreen/widget/filterCategoryList.dart';
...
class _ProductListFilterScreenState extends State<ProductListFilterScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.maxPrice <= 0 && widget.minPrice <= 0) {
    ...
    return Scaffold(
      ...
      body: WillPopScope(
        onWillPop: () async {
          // Perform the action similar to what is done in PopScope
                      ...
                      child: context
                          ...
                          : context
                              ...
                              : context
                                  ...
                                  : widget.minPrice != widget.maxPrice
                                      ? getPriceRangeWidget(widget.minPrice,
                                          widget.maxPrice, context)
                                      : const SizedBox.shrink(),
                    ),
                    GestureDetector(
                      onTap: () {
